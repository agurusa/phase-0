...
def binary_search(list, name)
  ...
  loop do
    ...
    if first_name_sorted[m] == name
      return first_name.find_index(name)
...
We reviewed iteration and attr_ methods.

What is still confusing to you about Ruby?
I'm confused about how we could have refactored the binary search. We couldn't quite figure out how to access the index value of the original student array because we were using a string to search for an object.

What are you going to study to get more prepared for Phase 1?
I'm going to study a bit more about classes and attr_.
